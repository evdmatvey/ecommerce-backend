export const ValidationErrors = {
  ...
  BRAND_EMPTY_TITLE: 'Укажите название бренда!',
  SUPER_SUBCATEGORY_EMPTY_TITLE: 'Укажите название супер подкатегории!',
  SUPER_CATEGORY_EMPTY_TITLE: 'Укажите название супер категории!',
};
